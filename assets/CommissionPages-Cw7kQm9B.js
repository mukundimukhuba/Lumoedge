...
function JoinForm({ admin, onReload, setNotice, busy, setBusy }) {
  const names = String(admin?.fullName || "").trim().split(/\s+/);
  ...
  return Y.jsxs("div", {
    ...
    children: [
      ...
      Y.jsx("p", {
        ...
        style: { marginTop: 0 },
        children:
          "Regular admins can start earning from qualifying paid subscriptions. Joining does not grant Super Admin permissions.",
      }),
      Y.jsxs("div", {
  ...
  return Y.jsxs("div", {
    ...
    children: [
      ...
      status === "rejected"
        ...
        : null,
      enrollment.canJoin ? Y.jsx(JoinForm, { admin, onReload, setNotice, busy, setBusy }) : null,
      Y.jsxs("div", {
