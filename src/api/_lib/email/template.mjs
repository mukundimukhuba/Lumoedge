      ...
      <tr>
        <td align="center" style="padding:12px 28px 28px;">
          <table role="presentation" cellspacing="0" cellpadding="0" border="0">
            <tr>
              <td align="center" bgcolor="#2563eb" style="border-radius:999px;background-color:#2563eb;">
                <a href="${ctaUrl}" target="_blank" rel="noopener noreferrer"
                   style="display:inline-block;padding:14px 28px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;border-radius:999px;">
                  ${ctaLabel}
                </a>
              </td>
            </tr>
...
<body style="margin:0;padding:0;background:#070b14;color:#e8eefc;">
  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#070b14;padding:24px 12px;">
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:560px;background:#0c1220;border:1px solid #1e3a5f;border-radius:18px;">
          <tr>
            <td align="center" style="padding:28px 24px 12px;">
              ...
              <div style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#93a4c7;margin-top:4px;">
          ...
          <tr>
            <td style="padding:18px 28px 28px;border-top:1px solid #334155;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:1.5;color:#8b9bb8;text-align:center;">
              <strong style="color:#c7d2ea;">Lumo Edge</strong><br/>
              Questions? Contact
              <a href="mailto:${SUPPORT_EMAIL}" style="color:#60a5fa;text-decoration:none;">${SUPPORT_EMAIL}</a><br/>
              <a href="${APP_HOME_URL}" target="_blank" style="color:#93a4c7;text-decoration:none;">${APP_HOME_URL}</a><br/>
              <span style="color:#64748b;">You received this email because you use Lumo Edge.</span>
            </td>
          </tr>
        </table>
      </td>
...
export function licenseKeyBox(key) {
  return `
  <div style="margin:18px 0;padding:16px 18px;border-radius:12px;background:#08101f;border:1px dashed #38bdf8;text-align:center;">
    <div style="font-size:11px;letter-spacing:0.12em;text-transform:uppercase;color:#7dd3fc;margin-bottom:8px;">Your License Key</div>
